...
namespace SchoolAPI.Controllers
{
    ...
    public class OrganizationController : ControllerBase
    {
        ...
        [ServiceFilter(typeof(ValidateOrgExistsAttribute))]
        ...
        public IActionResult CreateOrganization([FromBody] OrganizationCreationDto organization)
        {
            var organizationEntity = _mapper.Map<Organization>(organization);

            _repository.Organization.createOrg(organizationEntity);
            _repository.Save();
        ...
        [ServiceFilter(typeof(ValidationFilterAttribute))]
        [ServiceFilter(typeof(ValidateOrgExistsAttribute))]
        public IActionResult UpdateOrganization(Guid id, [FromBody] OrganizationUpdateDto organization)
        {
        ...
        public IActionResult DeleteOrganization(Guid id)
        {
            ...
            _repository.Organization.deleteOrg(organization);
            _repository.Save();
